...
export const formSchema = {
  "form": {
    ...
    "description": "Formulaire de demande de devis pour les services de nettoyage en Île-de-France.",
    ...
    "fields": [
      ...
      },
      {
        "id": "commonFields",
        "group": [
          { "id": "nom", "type": "text", "label": "Nom complet", "placeholder": "Ex : Jean Dupont", "required": true },
          { "id": "email", "type": "email", "label": "Adresse email", "placeholder": "Ex : contact@exemple.com", "required": true },
          { "id": "telephone", "type": "tel", "label": "Téléphone", "placeholder": "Ex : 0601020304" },
          { "id": "localisation", "type": "text", "label": "Ville ou code postal", "placeholder": "Ex : Paris 12e" }
        ]
      }
    ],
    "conditionalSections": {
      "restaurant": {
        ...
        "fields": [
          { "id": "type_nettoyage", "type": "select", "label": "Type de nettoyage", "options": [
            { "value": "complet", "label": "Complet (salle + cuisine, sans la hotte)" },
            { "value": "salle", "label": "Salle uniquement" },
            { "value": "cuisine", "label": "Cuisine uniquement" },
            { "value": "vitres", "label": "Vitres" }
          ]},
          { "id": "superficie", "type": "select", "label": "Superficie à nettoyer (en m²)", "options":  [
          ...
          { "id": "type_intervention", "type": "select", "label": "Type d’intervention", "options": [
            { "value": "ponctuelle", "label": "Ponctuelle" },
            { "value": "recurrente", "label": "Récurrente" }
          ]},
          { "id": "date_souhaitee", "type": "select", "label": "Date d’intervention souhaitée", "options": [
      ...
      "local_pro": {
        ...
        "fields": [
          { "id": "type_local", "type": "select", "label": "Type de local", "options": [
            { "value": "bureau", "label": "Bureau" },
            { "value": "salon", "label": "Salon de coiffure / Barber" },
            { "value": "commerce", "label": "Commerce" },
            { "value": "autre", "label": "Autre" }
          ]},
          { "id": "superficie", "type": "select", "label": "Superficie à nettoyer", "options": [
            { "value": "9-15", "label": "9m² - 15m²" },
            { "value": "15-30", "label": "15m² - 30m²" },
            { "value": "30-50", "label": "30m² - 50m²" },
            { "value": "50-80", "label": "50m² - 80m²" },
      ...
      "hotte": {
        ...
        "fields": [
          ...
          { "id": "type_etablissement", "type": "select", "label": "Type d’établissement", "options": [
            { "value": "restaurant", "label": "Restaurant" },
            { "value": "snack", "label": "Snack / Fast-food" },
            { "value": "cantine", "label": "Cantine / collectif" }
          ]},
          { "id": "longueur", "type": "select", "label": "Longueur de hotte (en mètres)", "options": [
            { "value": "1-3", "label": "1m - 3m" },
            { "value": "3-6", "label": "3m - 6m" },
            { "value": "8+", "label": "Plus de 8m" }
          ]},
          { "id": "encrassement", "type": "select", "label": "Niveau d’encrassement", "options": [
            { "value": "faible", "label": "Faible" },
            { "value": "moyen", "label": "Moyen" },
            { "value": "tres", "label": "Très encrassé" },
            { "value": "unknown", "label": "Je ne sais pas" }
          ]},
          { "id": "derniere_visite", "type": "date", "label": "Dernière visite de nettoyage" }
        ]
      },
      "vitres": {
        "label": "Détails pour le nettoyage de vitres",
        "fields": [
          { "id": "type_lieu", "type": "select", "label": "Type de lieu", "options": [
          ...
          { "id": "type_vitres", "type": "select", "label": "Type de vitres", "options": [
    ...
    "finalFields": [
      { "id": "message", "type": "textarea", "label": "Message utile / précisions", "placeholder": "Décrivez vos besoins ou contraintes particulières" },
      { "id": "accept_rgpd", "type": "checkbox", "label": "J’accepte le traitement de mes données conformément à la politique de confidentialité.", "required": true }
    ],
    "submission": {
      "method": "POST",
      "endpoint": "/api/devis",
