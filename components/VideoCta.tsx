...
const VideoCta: React.FC = () => {
    return (
        <section 
            ...
            style={{ backgroundImage: "url('https://storage.googleapis.com/aai-web-samples/public/pro-builder/cleaning-video-bg.png')" }}
        >
            ...
            >
                <span className="font-semibold text-sm tracking-widest transition-colors group-hover:text-brand-teal">LECTURE</span>
            </motion.button>
        </section>
    );
};
